...
class View
{
     ...
     * @throws Exception
     */
    public function tptch($template = '', $vars = [], $replace = [], $config = [], $renderContent = false)
    {
        // 模板变量
        ...
        // 渲染输出
        $method = $renderContent ? 'display' : 'tptch';
    ...
    {
        return $this->tptch($content, $vars, $replace, $config, true);
    }
