...
<body>
    ...
    <div class="copyright">
        <a title="官方网站" href="https://shop116885045.taobao.com/shop/view_shop.htm?spm=a313o.201708ban.category.d53.483382ffpTcSpS&mytmenu=mdianpu&user_number_id=1042664704">网站开发工作室</a>
        <span>{ 基于ThinkPHP5开发框架，致力于为您创建一个高效简洁但安全稳定的网站程序 }</span>
    </div>
    <?php if(\think\App::$debug) { ?>
    <script>
