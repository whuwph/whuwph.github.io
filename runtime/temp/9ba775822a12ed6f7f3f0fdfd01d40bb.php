<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"./template/default/login_index.html";i:1514020524;s:36:"./template/default/index_header.html";i:1558972505;s:37:"./template/default/public_gradeh.html";i:1504321936;s:36:"./template/default/index_footer.html";i:1514127398;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
<title>登录 - 后台管理</title>
...
<img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" style="float:left; cursor:pointer;" alt="captcha" />
</div>
<?php endif; ?>
<div class="layui-form-item">
...
<?php if(config('web.WEB_LOG') == 3): ?>或者使用QQ账号登录<a class="login" href="javascript:void(0)"><i class="iconfont" style="font-size: 20px;margin-left: 8px;position: relative;top: 2px;color: #7CA9C9;">&#xe613;</i><?php endif; ?>
</div>
</div> 
</div>
</div>
...
jq.post('<?php echo url("index/login/index"); ?>',param,function(data){
if(data.code == 200){
layer.close(loading);
