<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"./template/default/user_home.html";i:1510808610;s:36:"./template/default/index_header.html";i:1558972505;s:37:"./template/default/public_gradeh.html";i:1504321936;s:36:"./template/default/index_footer.html";i:1514127398;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
...
<h1>
<?php echo $tptm['username']; if($tptm['sex'] == 1): ?> <i class="layui-icon icon-nan">&#xe662;</i><?php else: ?> <i class="layui-icon icon-nv">&#xe661;</i><?php endif; ?>
</h1>
<p class="fly-home-info">
<i class="layui-icon">&#xe735;</i><span style="color: #FF7200;"><?php echo $tptm['point']; ?></span>
<i class="layui-icon">&#xe60e;</i><span><?php echo date("Y-m-d",$tptm['usertime']); ?> 加入</span>
<i class="layui-icon">&#xe715;</i><span><?php if($tptm['userhome'] != ''): ?><?php echo $tptm['userhome']; else: ?>中国<?php endif; ?></span>
</p>
